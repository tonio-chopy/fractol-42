...
void  change_color(int key, t_engine *t_engine)
{
  if (key == KEY_Q)
    engine->fractol.color += 0x300000;
  else if (key == KEY_W)
    engine->fractol.color += 0x030000;
  else if (key == KEY_E)
    engine->fractol.color += 0x003000;
  else if (key == KEY_R)
    engine->fractol.color += 0x000300;
  else if (key == KEY_T)
    engine->fractol.color += 0x000030;
  else if (key == KEY_Y)
    engine->fractol.color += 0x000003;
}
